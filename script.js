...
const translations = {
  uz: {
    ...
    'project-runcity-desc': 'RunCity — "Shaharni Zabt Et" web loyihasi. O‘yin logikasi va interaktiv tajriba orqali shaharni zabt etish g‘oyasi amalga oshirilgan.',
    'project-runcity-mini': 'GPS va heatmap orqali shahar hududini zabt eting.',
    'project-resumio-desc': 'Resumio — CV yaratish, yangilash va ulashishni soddalashtiradi. Shablonlar, PDF eksport va maxfiylikka e’tibor.',
    'project-resumio-mini': 'Bepul va ochiq manbali resume tuzish veb-sayti.',
    'contact-title': 'Aloqa',
    ...
    'cyber-title': 'Etik Hacking',
    'cyber-subtitle': 'Kiberxavfsizlik bo\'yicha ko\'nikmalarim va CTF platformalari',
    'cyber-sk-web': 'Web Exploitation',
    'cyber-sk-web-desc': 'Veb-saytlardagi zaifliklarni topish: SQL injection, XSS, CSRF.',
    'cyber-sk-crypto': 'Kriptografiya',
    'cyber-sk-crypto-desc': 'Shifrlash va hash algoritmlari: RSA, AES, SHA bilan ishlash.',
    'cyber-sk-osint': 'OSINT',
    'cyber-sk-osint-desc': 'Ochiq manbalardan ma\'lumot yig\'ish va tahlil qilish.',
    'cyber-sk-network': 'Tarmoq xavfsizligi',
    'cyber-sk-network-desc': 'Tarmoqni skanerlash va paketlarni tahlil qilish (Nmap, Wireshark).',
    'cyber-sk-linux': 'Linux va Bash',
    'cyber-sk-linux-desc': 'Kali Linux, shell skriptlar va privilege escalation.',
    'cyber-sk-pentest': 'Penetration Testing',
    'cyber-sk-pentest-desc': 'Tizimlarni qonuniy testlash va xavfsizlik hisobotlari yozish.',
    'cyber-platforms-title': 'CTF Platformalari',
    'cyber-pico-desc': 'Carnegie Mellon universitetining CTF platformasi.',
    'cyber-thm-desc': 'Amaliy kiberxavfsizlik xonalari va o\'quv yo\'llari.',
    'cyber-htb-desc': 'Haqiqiy mashinalarni hack qilish — professional daraja.',
    'cyber-otw-desc': 'Wargames — Bandit, Natas va boshqa darajalar.',
    'cyber-tools-title': 'Asboblar'
  },
  en: {
    ...
    'project-view': 'View',
    'project-runcity-desc': 'RunCity — "Shaharni Zabt Et" web project. The idea of taking over the city is implemented through game logic and an interactive experience.',
    'project-runcity-mini': 'Take over city districts with GPS + heatmap.',
    'project-resumio-desc': 'Resumio simplifies creating, updating, and sharing your resume. Templates, PDF export, and privacy-first design.',
    'project-resumio-mini': 'Free and open-source resume builder website.',
    ...
    'cyber-title': 'Ethical Hacking',
    'cyber-subtitle': 'My cybersecurity skills and CTF platforms',
    'cyber-sk-web': 'Web Exploitation',
    'cyber-sk-web-desc': 'Finding vulnerabilities in websites: SQL injection, XSS, CSRF.',
    'cyber-sk-crypto': 'Cryptography',
    'cyber-sk-crypto-desc': 'Working with encryption and hashing: RSA, AES, SHA.',
    'cyber-sk-osint': 'OSINT',
    'cyber-sk-osint-desc': 'Gathering and analyzing information from open sources.',
    'cyber-sk-network': 'Network Security',
    'cyber-sk-network-desc': 'Network scanning and packet analysis (Nmap, Wireshark).',
    'cyber-sk-linux': 'Linux & Bash',
    'cyber-sk-linux-desc': 'Kali Linux, shell scripting, and privilege escalation.',
    'cyber-sk-pentest': 'Penetration Testing',
    'cyber-sk-pentest-desc': 'Legally testing systems and writing security reports.',
    'cyber-platforms-title': 'CTF Platforms',
    'cyber-pico-desc': 'A CTF platform by Carnegie Mellon University.',
    'cyber-thm-desc': 'Hands-on cybersecurity rooms and learning paths.',
    'cyber-htb-desc': 'Hack real machines — professional level.',
    'cyber-otw-desc': 'Wargames — Bandit, Natas and other levels.',
    'cyber-tools-title': 'Tools'
  },
  ru: {
    ...
    'project-runcity-desc': 'RunCity — веб-проект «Shaharni Zabt Et». Идея захвата города реализована через игровую логику и интерактивный опыт.',
    'project-runcity-mini': 'Захватывайте городские районы с помощью GPS и heatmap.',
    'project-resumio-desc': 'Resumio упрощает создание, обновление и публикацию резюме. Шаблоны, экспорт в PDF и приватность.',
    'project-resumio-mini': 'Бесплатный open-source конструктор резюме.',
    ...
    'cyber-title': 'Этичный хакинг',
    'cyber-subtitle': 'Мои навыки в кибербезопасности и CTF-платформы',
    'cyber-sk-web': 'Web-эксплуатация',
    'cyber-sk-web-desc': 'Поиск уязвимостей сайтов: SQL injection, XSS, CSRF.',
    'cyber-sk-crypto': 'Криптография',
    'cyber-sk-crypto-desc': 'Работа с шифрованием и хешированием: RSA, AES, SHA.',
    'cyber-sk-osint': 'OSINT',
    'cyber-sk-osint-desc': 'Сбор и анализ информации из открытых источников.',
    'cyber-sk-network': 'Сетевая безопасность',
    'cyber-sk-network-desc': 'Сканирование сети и анализ пакетов (Nmap, Wireshark).',
    'cyber-sk-linux': 'Linux и Bash',
    'cyber-sk-linux-desc': 'Kali Linux, shell-скрипты и privilege escalation.',
    'cyber-sk-pentest': 'Пентестинг',
    'cyber-sk-pentest-desc': 'Легальное тестирование систем и написание отчётов.',
    'cyber-platforms-title': 'CTF-платформы',
    'cyber-pico-desc': 'CTF-платформа от Carnegie Mellon University.',
    'cyber-thm-desc': 'Практические комнаты и пути обучения.',
    'cyber-htb-desc': 'Взлом реальных машин — профессиональный уровень.',
    'cyber-otw-desc': 'Wargames — Bandit, Natas и другие уровни.',
    'cyber-tools-title': 'Инструменты'
  }
};
